...
function (_Component) {
  ...
  function Hello() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Hello).call(this));
    _this.state = {
  ...
  _createClass(Hello, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, this.state.title);
    }
  }]);
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Hello, null), document.getElementById('hello'));
